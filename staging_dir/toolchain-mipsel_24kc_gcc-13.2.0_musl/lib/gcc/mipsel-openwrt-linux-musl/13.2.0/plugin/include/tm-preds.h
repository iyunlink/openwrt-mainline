/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/yang/iyunlink/openwrt-mainline/build_dir/toolchain-mipsel_24kc_gcc-13.2.0_musl/gcc-13.2.0/gcc/config/mips/mips.md'.  */
