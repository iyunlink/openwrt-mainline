...
enum opt_code
{
  ...
  OPT_fhonour_copts = 1268,                  /* -fhonour-copts */
  OPT_fhosted = 1269,                        /* -fhosted */
  OPT_fhuge_objects = 1270,                  /* -fhuge-objects */
  OPT_fident = 1271,                         /* -fident */
  OPT_fif_conversion = 1272,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1273,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1274,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1275,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1276,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1277,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1278,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1279,            /* -fimplicit-templates */
  OPT_findex = 1280,                         /* -findex */
  OPT_findirect_inlining = 1281,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1282,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1283,               /* -finit-character= */
  OPT_finit_derived = 1284,                  /* -finit-derived */
  OPT_finit_integer_ = 1285,                 /* -finit-integer= */
  OPT_finit_local_zero = 1286,               /* -finit-local-zero */
  OPT_finit_logical_ = 1287,                 /* -finit-logical= */
  OPT_finit_real_ = 1288,                    /* -finit-real= */
  OPT_finline = 1289,                        /* -finline */
  OPT_finline_arg_packing = 1290,            /* -finline-arg-packing */
  OPT_finline_atomics = 1291,                /* -finline-atomics */
  OPT_finline_functions = 1292,              /* -finline-functions */
  OPT_finline_functions_called_once = 1293,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1294, */           /* -finline-limit- */
  OPT_finline_limit_ = 1295,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1296,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1297,        /* -finline-small-functions */
  OPT_finput_charset_ = 1298,                /* -finput-charset= */
  OPT_finstrument_functions = 1299,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1300,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1301,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1302,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1303,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1304,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1305,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1306,                    /* -finvariants */
  OPT_fipa_bit_cp = 1307,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1308,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1309, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1310,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1311,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1312,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1313,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1314, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1315,                    /* -fipa-modref */
  OPT_fipa_profile = 1316,                   /* -fipa-profile */
  OPT_fipa_pta = 1317,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1318,                /* -fipa-pure-const */
  OPT_fipa_ra = 1319,                        /* -fipa-ra */
  OPT_fipa_reference = 1320,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1321,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1322,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1323,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1324,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1325, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1326,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1327,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1328,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1329,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1330,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1331,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1332,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1333,                  /* -fira-verbose= */
  OPT_fiso = 1334,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1335,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1336,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1337,              /* -fivar-visibility= */
  OPT_fivopts = 1338,                        /* -fivopts */
  OPT_fjump_tables = 1339,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1340,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1341,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1342,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1343,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1344,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1345,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1346,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1347,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1348,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1349,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1350,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1351,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1352,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1353,            /* -fleading-underscore */
  OPT_flibs_ = 1354,                         /* -flibs= */
  OPT_flifetime_dse = 1355,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1356,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1357,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1358,                /* -flinker-output= */
  /* OPT_flive_patching = 1359, */           /* -flive-patching */
  OPT_flive_patching_ = 1360,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1361,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1362,                   /* -flocal-ivars */
  OPT_flocation_ = 1363,                     /* -flocation= */
  /* OPT_floop_block = 1364, */              /* -floop-block */
  /* OPT_floop_flatten = 1365, */            /* -floop-flatten */
  OPT_floop_interchange = 1366,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1367,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1368, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1369,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1370, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1371,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1372,                     /* -flra-remat */
  OPT_flto = 1373,                           /* -flto */
  OPT_flto_compression_level_ = 1374,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1375, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1376,                /* -flto-partition= */
  OPT_flto_report = 1377,                    /* -flto-report */
  OPT_flto_report_wpa = 1378,                /* -flto-report-wpa */
  OPT_flto_ = 1379,                          /* -flto= */
  OPT_fltrans = 1380,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1381,           /* -fltrans-output-list= */
  OPT_fm2_g = 1382,                          /* -fm2-g */
  OPT_fm2_lower_case = 1383,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1384,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1385,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1386,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1387,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1388,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1389,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1390,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1391,             /* -fmacro-prefix-map= */
  OPT_fmain = 1392,                          /* -fmain */
  OPT_fmath_errno = 1393,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1394,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1395,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1396,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1397,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1398,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1399,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1400,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1401,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1402,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1403,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1404,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1405,               /* -fmessage-length= */
  OPT_fmod_ = 1406,                          /* -fmod= */
  OPT_fmodule_file_ = 1407,                  /* -fmodule-file= */
  OPT_fmodule_header = 1408,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1409,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1410,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1411,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1412,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1413,                   /* -fmodule-only */
  OPT_fmodule_private = 1414,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1415,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1416,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1417,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1418,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1419,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1420,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1421,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1422,                 /* -fms-extensions */
  OPT_fmudflap = 1423,                       /* -fmudflap */
  OPT_fmudflapir = 1424,                     /* -fmudflapir */
  OPT_fmudflapth = 1425,                     /* -fmudflapth */
  OPT_fmultiflags = 1426,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1427,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1428,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1429,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1430,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1431,                  /* -fnext-runtime */
  OPT_fnil = 1432,                           /* -fnil */
  OPT_fnil_receivers = 1433,                 /* -fnil-receivers */
  OPT_fno_modules = 1434,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1435,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1436,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1437,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1438,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1439,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1440,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1441,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1442,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1443,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1444,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1445,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1446,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1447,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1448,              /* -foffload-options= */
  OPT_foffload_ = 1449,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1450,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1451,                         /* -fonly= */
  OPT_fopenacc = 1452,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1453,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1454,                        /* -fopenmp */
  OPT_fopenmp_simd = 1455,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1456, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1457,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1458,                /* -foperator-names */
  OPT_fopt_info = 1459,                      /* -fopt-info */
  OPT_fopt_info_ = 1460,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1461, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1462,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1463,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1464, */          /* -foptional-diags */
  OPT_fpack_derived = 1465,                  /* -fpack-derived */
  OPT_fpack_struct = 1466,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1467,                  /* -fpack-struct= */
  OPT_fpad_source = 1468,                    /* -fpad-source */
  OPT_fpartial_inlining = 1469,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1470,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1471,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1472,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1473,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1474,                    /* -fpeel-loops */
  OPT_fpeephole = 1475,                      /* -fpeephole */
  OPT_fpeephole2 = 1476,                     /* -fpeephole2 */
  OPT_fpermissive = 1477,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1478,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1479,                           /* -fpic */
  OPT_fpie = 1480,                           /* -fpie */
  OPT_fpim = 1481,                           /* -fpim */
  OPT_fpim2 = 1482,                          /* -fpim2 */
  OPT_fpim3 = 1483,                          /* -fpim3 */
  OPT_fpim4 = 1484,                          /* -fpim4 */
  OPT_fplan9_extensions = 1485,              /* -fplan9-extensions */
  OPT_fplt = 1486,                           /* -fplt */
  OPT_fplugin_arg_ = 1487,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1488,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1489,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1490,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1491,                /* -fpostconditions */
  OPT_fpre_include_ = 1492,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1493,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1494,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1495,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1496,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1497,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1498,              /* -fpretty-templates */
  OPT_fpreview_all = 1499,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1500,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1501,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1502,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1503,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1504,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1505,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1506,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1507,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1508,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1509,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1510,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1511,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1512,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1513,           /* -fprintf-return-value */
  OPT_fprofile = 1514,                       /* -fprofile */
  OPT_fprofile_abs_path = 1515,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1516,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1517,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1518,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1519,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1520,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1521,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1522,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1523,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1524,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1525,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1526,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1527,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1528,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1529,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1530,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1531,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1532,               /* -fprofile-update= */
  OPT_fprofile_use = 1533,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1534,                  /* -fprofile-use= */
  OPT_fprofile_values = 1535,                /* -fprofile-values */
  OPT_fprotect_parens = 1536,                /* -fprotect-parens */
  OPT_fpthread = 1537,                       /* -fpthread */
  OPT_fq = 1538,                             /* -fq */
  OPT_frandom_seed = 1539,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1540,                  /* -frandom-seed= */
  OPT_frange = 1541,                         /* -frange */
  OPT_frange_check = 1542,                   /* -frange-check */
  OPT_freal_4_real_10 = 1543,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1544,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1545,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1546,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1547,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1548,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1549,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1550,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1551,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1552,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1553,               /* -frecord-marker=8 */
  OPT_frecursive = 1554,                     /* -frecursive */
  OPT_free = 1555,                           /* -free */
  OPT_freg_struct_return = 1556,             /* -freg-struct-return */
  /* OPT_fregmove = 1557, */                 /* -fregmove */
  OPT_frelease = 1558,                       /* -frelease */
  OPT_frename_registers = 1559,              /* -frename-registers */
  OPT_freorder_blocks = 1560,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1561,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1562,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1563,             /* -freorder-functions */
  OPT_frepack_arrays = 1564,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1565,          /* -freplace-objc-classes */
  OPT_frepo = 1566,                          /* -frepo */
  OPT_freport_bug = 1567,                    /* -freport-bug */
  OPT_frequire_return_statement = 1568,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1569,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1570, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1571,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1572,                   /* -fresolution= */
  OPT_freturn = 1573,                        /* -freturn */
  OPT_frevert_all = 1574,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1575,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1576,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1577,             /* -frevert=intpromote */
  OPT_frounding_math = 1578,                 /* -frounding-math */
  OPT_frtti = 1579,                          /* -frtti */
  OPT_fruntime_modules_ = 1580,              /* -fruntime-modules= */
  OPT_frust_cfg_ = 1581,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1582,           /* -frust-compile-until= */
  OPT_frust_crate_ = 1583,                   /* -frust-crate= */
  OPT_frust_debug = 1584,                    /* -frust-debug */
  OPT_frust_dump_ = 1585,                    /* -frust-dump- */
  OPT_frust_edition_ = 1586,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1587,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1588,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1589,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1590,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1591,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1592,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1593,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1594,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1595,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1596,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1597,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1598,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1599, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1600,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1601,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1602,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1603,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1604,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1605,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1606,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1607,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1608, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1609,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1610,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1611,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1612,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1613,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1614,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1615,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1616,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1617,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1618,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1619,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1620,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1621,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1622,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1623,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1624,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1625, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1626,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1627,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1628,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1629,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1630,               /* -fsection-anchors */
  /* OPT_fsee = 1631, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1632,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1633,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1634,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1635,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1636,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1637,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1638,        /* -fsemantic-interposition */
  ...
  OPT_list = 1888,                           /* -list */
  OPT_mabi_ = 1889,                          /* -mabi= */
  OPT_mabicalls = 1890,                      /* -mabicalls */
  OPT_mabs_ = 1891,                          /* -mabs= */
  OPT_mandroid = 1892,                       /* -mandroid */
  OPT_march_ = 1893,                         /* -march= */
  OPT_mbionic = 1894,                        /* -mbionic */
  OPT_mbranch_cost_ = 1895,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1896,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1897,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1898,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1899,             /* -mcompact-branches= */
  OPT_mcrc = 1900,                           /* -mcrc */
  OPT_mdebug = 1901,                         /* -mdebug */
  OPT_mdebugd = 1902,                        /* -mdebugd */
  OPT_mdivide_breaks = 1903,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1904,                  /* -mdivide-traps */
  OPT_mdmx = 1905,                           /* -mdmx */
  OPT_mdouble_float = 1906,                  /* -mdouble-float */
  OPT_mdsp = 1907,                           /* -mdsp */
  OPT_mdspr2 = 1908,                         /* -mdspr2 */
  OPT_meb = 1909,                            /* -meb */
  OPT_mel = 1910,                            /* -mel */
  OPT_membedded_data = 1911,                 /* -membedded-data */
  OPT_meva = 1912,                           /* -meva */
  OPT_mexplicit_relocs = 1913,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1914,                  /* -mextern-sdata */
  OPT_mfix_24k = 1915,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1916,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1917,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1918,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1919,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1920,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1921,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1922,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1923,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1924,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1925,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1926,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1927,                 /* -mfp-exceptions */
  OPT_mfp32 = 1928,                          /* -mfp32 */
  OPT_mfp64 = 1929,                          /* -mfp64 */
  OPT_mfpxx = 1930,                          /* -mfpxx */
  OPT_mframe_header_opt = 1931,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1932, */              /* -mfused-madd */
  OPT_mginv = 1933,                          /* -mginv */
  OPT_mglibc = 1934,                         /* -mglibc */
  OPT_mgp32 = 1935,                          /* -mgp32 */
  OPT_mgp64 = 1936,                          /* -mgp64 */
  OPT_mgpopt = 1937,                         /* -mgpopt */
  OPT_mhard_float = 1938,                    /* -mhard-float */
  OPT_mimadd = 1939,                         /* -mimadd */
  OPT_minterlink_compressed = 1940,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1941,              /* -minterlink-mips16 */
  OPT_mips = 1942,                           /* -mips */
  OPT_mips16 = 1943,                         /* -mips16 */
  OPT_mips3d = 1944,                         /* -mips3d */
  OPT_mllsc = 1945,                          /* -mllsc */
  OPT_mload_store_pairs = 1946,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1947,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1948,                    /* -mlong-calls */
  OPT_mlong32 = 1949,                        /* -mlong32 */
  OPT_mlong64 = 1950,                        /* -mlong64 */
  OPT_mloongson_ext = 1951,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1952,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1953,                  /* -mloongson-mmi */
  OPT_mlra = 1954,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1955,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1956,                           /* -mmad */
  OPT_mmadd4 = 1957,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1958,             /* -mmcount-ra-address */
  OPT_mmcu = 1959,                           /* -mmcu */
  OPT_mmemcpy = 1960,                        /* -mmemcpy */
  OPT_mmicromips = 1961,                     /* -mmicromips */
  OPT_mmsa = 1962,                           /* -mmsa */
  OPT_mmt = 1963,                            /* -mmt */
  OPT_mmusl = 1964,                          /* -mmusl */
  OPT_mnan_ = 1965,                          /* -mnan= */
  OPT_mno_float = 1966,                      /* -mno-float */
  OPT_mno_flush_func = 1967,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1968,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1969,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1970,                     /* -mno-mips3d */
  OPT_modd_spreg = 1971,                     /* -modd-spreg */
  OPT_mpaired_single = 1972,                 /* -mpaired-single */
  OPT_mplt = 1973,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1974,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1975,               /* -mrelax-pic-calls */
  OPT_mshared = 1976,                        /* -mshared */
  OPT_msingle_float = 1977,                  /* -msingle-float */
  OPT_msmartmips = 1978,                     /* -msmartmips */
  OPT_msoft_float = 1979,                    /* -msoft-float */
  OPT_msplit_addresses = 1980,               /* -msplit-addresses */
  OPT_msym32 = 1981,                         /* -msym32 */
  OPT_msynci = 1982,                         /* -msynci */
  OPT_mtune_ = 1983,                         /* -mtune= */
  OPT_muclibc = 1984,                        /* -muclibc */
  OPT_munaligned_access = 1985,              /* -munaligned-access */
  OPT_muninit_const_in_rodata = 1986,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1987,                          /* -mvirt */
  OPT_mvr4130_align = 1988,                  /* -mvr4130-align */
  OPT_mxgot = 1989,                          /* -mxgot */
  OPT_mxpa = 1990,                           /* -mxpa */
  OPT_n = 1991,                              /* -n */
  OPT_name_sort = 1992,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1993,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1994,              /* -no-integrated-cpp */
  OPT_no_pie = 1995,                         /* -no-pie */
  OPT_noasmopt = 1996,                       /* -noasmopt */
  OPT_nocpp = 1997,                          /* -nocpp */
  OPT_nodefaultlibs = 1998,                  /* -nodefaultlibs */
  OPT_nolibc = 1999,                         /* -nolibc */
  OPT_nophoboslib = 2000,                    /* -nophoboslib */
  OPT_nostartfiles = 2001,                   /* -nostartfiles */
  OPT_nostdinc = 2002,                       /* -nostdinc */
  OPT_nostdinc__ = 2003,                     /* -nostdinc++ */
  OPT_nostdlib = 2004,                       /* -nostdlib */
  OPT_nostdlib__ = 2005,                     /* -nostdlib++ */
  OPT_o = 2006,                              /* -o */
  OPT_objects = 2007,                        /* -objects */
  OPT_p = 2008,                              /* -p */
  OPT_pass_exit_codes = 2009,                /* -pass-exit-codes */
  /* OPT_pedantic = 2010, */                 /* -pedantic */
  OPT_pedantic_errors = 2011,                /* -pedantic-errors */
  OPT_pg = 2012,                             /* -pg */
  OPT_pie = 2013,                            /* -pie */
  OPT_pipe = 2014,                           /* -pipe */
  OPT_posix = 2015,                          /* -posix */
  ...
  OPT_profile = 2028,                        /* -profile */
  OPT_pthread = 2029,                        /* -pthread */
  OPT_quiet = 2030,                          /* -quiet */
  OPT_r = 2031,                              /* -r */
  OPT_rdynamic = 2032,                       /* -rdynamic */
  ...
  /* OPT_std_c__2a = 2069, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2070, */                /* -std=c++2b */
  OPT_std_c__98 = 2071,                      /* -std=c++98 */
  OPT_std_c11 = 2072,                        /* -std=c11 */
  OPT_std_c17 = 2073,                        /* -std=c17 */
  /* OPT_std_c18 = 2074, */                  /* -std=c18 */
  /* OPT_std_c1x = 2075, */                  /* -std=c1x */
  OPT_std_c2x = 2076,                        /* -std=c2x */
  /* OPT_std_c89 = 2077, */                  /* -std=c89 */
  OPT_std_c90 = 2078,                        /* -std=c90 */
  OPT_std_c99 = 2079,                        /* -std=c99 */
  /* OPT_std_c9x = 2080, */                  /* -std=c9x */
  OPT_std_f2003 = 2081,                      /* -std=f2003 */
  OPT_std_f2008 = 2082,                      /* -std=f2008 */
  OPT_std_f2008ts = 2083,                    /* -std=f2008ts */
  OPT_std_f2018 = 2084,                      /* -std=f2018 */
  OPT_std_f95 = 2085,                        /* -std=f95 */
  OPT_std_gnu = 2086,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2087, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2088, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2089,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2090,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2091,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2092, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2093, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2094,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2095,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2096, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2097, */              /* -std=gnu++2b */
  ...
  OPT_std_gnu2x = 2103,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2104, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2105,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2106,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2107, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2108, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2109,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2110, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2111, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2112, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2113, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2114, */         /* -std=iso9899:2018 */
  ...
  OPT_time = 2120,                           /* -time */
  OPT_time_ = 2121,                          /* -time= */
  OPT_tno_android_cc = 2122,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2123,                 /* -tno-android-ld */
